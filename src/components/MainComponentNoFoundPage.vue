<template>
  <body>
    <div class="main_body">
      <div class="no_found_image">
        <img src='@/assets/nofoundimage.png' alt="Not found nofoundimage" widht="570px" height="700px">
      </div>
      <div class="text">
        <p>Oops! We didn't predict that move!</p>
      </div>
      <a href="/InitPage" class="button">Go back to init page</a>
    </div>
  </body>
</template>
